...
export function useThemeColors() {
  ...
  return {
    ...
    textColors: {
      primary: isDark ? "var(--color-primary-foreground)" : "var(--color-primary)",
      secondary: isDark ? "var(--color-secondary-foreground)" : "var(--color-secondary)",
    ...
    bgColors: {
      ...
      secondary: isDark ? "var(--color-secondary)" : "var(--color-secondary-foreground)",
      muted: isDark ? "var(--color-muted)" : "var(--color-muted-foreground)",
      accent: isDark ? "var(--color-accent)" : "var(--color-accent-foreground)",
    },
    iconColors: {
      primary: isDark ? "var(--wisely-mint)" : "var(--wisely-purple)",
      secondary: isDark ? "var(--wisely-pink)" : "var(--wisely-darkPurple)",

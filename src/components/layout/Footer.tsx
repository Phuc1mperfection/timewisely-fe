...
const FooterSection = () => (
  <footer className="relative z-10 w-full bg-white text-foreground dark:bg-black border-t border-[var(--wisely-champagne)]/20">
    <div className="w-full px-8 py-12 h-6">
      {/* Top Footer Section */}
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8  border-b border-[var(--wisely-champagne)]/20"
        initial={{
          opacity: 0,
          y: 20,
        }}

...
export const ActivityCard: React.FC<ActivityCardProps> = ({ activity, onToggleComplete }) => {
  ...
  return (
    <Card className={`transition-all duration-200 hover:shadow-md border-l-4 ${getColorClass(activity.color)} ${
      activity.completed 
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            ...
            <div className={`flex items-center gap-2 text-sm ml-9 ${
              activity.completed ? 'text-gray-400' : 'text-wisely-gray'
            }`}>
              <Clock size={16} />
              <span>

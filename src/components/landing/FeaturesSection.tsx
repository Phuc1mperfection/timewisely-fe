...
const FeaturesSection = ({
  ...
  return (
    <section
      ref={sectionRef}
      id="features"
      className="mx-auto px-6 py-16 relative z-10 bg-white"
    >
      <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h3 className="text-3xl font-bold mb-6 text-[var(--wisely-dark)]">
                ...
                <span className="text-[var(--wisely-purple)]"> Intelligent Planning</span>
              </h3>
            ...
            >
              <div className=" p-6 rounded-2xl border border-white/20">
                <div className="space-y-4">
                  <motion.div
                    className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-lg"
                    initial={{ opacity: 0, y: 20 }}
                    animate={
                      intelligentPlanningInView
                        ? { opacity: 1, y: 0 }
                  ...
                  <motion.div
                    className="flex items-center justify-between p-3 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 rounded-lg"
                    initial={{ opacity: 0, y: 20 }}
                    animate={
                      intelligentPlanningInView
                        ? { opacity: 1, y: 0 }
                  ...
                  <motion.div
                    className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-500/10 to-rose-500/10 rounded-lg"
                    initial={{ opacity: 0, y: 20 }}
                    animate={
                      intelligentPlanningInView
                        ? { opacity: 1, y: 0 }

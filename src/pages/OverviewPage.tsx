  ...
  return (
    <div className="flex-1 p-6 space-y-6">
      <div>
        ...
        <p className="text-[var(--wisely-gray)]">Let's do something cool </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-white border border-yellow-300 shadow-sm ">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Target className="h-4 w-4 text-[var(--wisely-champagne)]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[var(--wisely-dark)]">
              5
        ...
        <Card className="bg-white border border-yellow-300 shadow-sm ">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <TrendingUp className="h-4 w-4 text-[var(--wisely-sand)]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[var(--wisely-dark)]">
              78%
        ...
        <Card className="bg-white border border-yellow-300 shadow-sm ">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Sparkles className="h-4 w-4 text-[var(--wisely-gold)]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[var(--wisely-dark)]">
              3 new
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link to="/dashboard/calendar">
          <Card className="bg-white border border-yellow-300 shadow-sm  hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader className="text-center">
              <CalendarIcon className="h-8 w-8 text-[var(--wisely-gold)] mx-auto mb-2" />
              <CardTitle className="text-[var(--wisely-dark)]">
                Calendar
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-[var(--wisely-gray)] text-center">
        ...
        <Link to="/dashboard/motivation">
          <Card className="bg-white border border-yellow-300 shadow-sm  hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader className="text-center">
              <Sparkles className="h-8 w-8 text-[var(--wisely-champagne)] mx-auto mb-2" />
              <CardTitle className="text-[var(--wisely-dark)]">
                Daily Motivation
              </CardTitle>
            </CardHeader>
        ...
        <Link to="/dashboard/goals">
          <Card className="bg-white border border-yellow-300 shadow-sm  hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader className="text-center">
              <Target className="h-8 w-8 text-[var(--wisely-sand)] mx-auto mb-2" />
        ...
        <Link to="/dashboard/ai-suggestions">
          <Card className="bg-white border border-yellow-300 shadow-sm  hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader className="text-center">
              <Sparkles className="h-8 w-8 text-[var(--wisely-gold)] mx-auto mb-2" />
              <CardTitle className="text-[var(--wisely-dark)]">
                AI Suggestions
              </CardTitle>
            </CardHeader>
